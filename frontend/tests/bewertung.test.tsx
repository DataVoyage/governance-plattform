...
// Die Ausgangslage liefert der Server bei jedem Schritt mit: Sie ist kein
// Zwischenstand, sondern die Wiedergabe der erklärten Erwartung (E-65).
const AUSGANGSLAGE = {
  ur_stufe: 2,
  reichweite: 'bereich',
